module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    clean: {
      ...
      server: '.tmp',
      l10n: 'app/assets/autogenerated/i18n/*.json'
    ...
    copy: {
      ...
      styles: {
        expand: true,
        cwd: '<%= skeleton.app %>/assets/styles',
        dest: '.tmp/styles/',
        src: '{,*/}*.css'
      },
      alternate: {
        ...
        files: [
          {
            expand: true,
            dot: true,
            cwd:'<%= skeleton.app %>/assets',
            dest: '<%= skeleton.dist %>/assets',
            src: [
              "{,*/}*.*"
            ]
          }
    ...
    i18next: {
      concat: {
        src: ['app/**/i18n'],
        dest: 'app/assets/autogenerated/i18n'
      }
    }
  });
